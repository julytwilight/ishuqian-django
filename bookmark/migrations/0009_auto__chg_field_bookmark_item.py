...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bookmark.item'
        db.alter_column(u'bookmark_bookmark', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookmark.Item'], null=True))

    def backwards(self, orm):

        # Changing field 'Bookmark.item'
        db.alter_column(u'bookmark_bookmark', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bookmark.Item']))
    ...
    models = {
        u'bookmark.bookmark': {
            ...
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bookmark.Item']", 'null': 'True', 'blank': 'True'}),
