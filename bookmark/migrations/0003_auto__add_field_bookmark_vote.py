...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bookmark.vote'
        db.add_column(u'bookmark_bookmark', 'vote',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bookmark.vote'
        db.delete_column(u'bookmark_bookmark', 'vote')
    ...
    models = {
        u'bookmark.bookmark': {
            ...
            'vote': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
        u'bookmark.list': {
        ...
        u'ishuqian.user': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 24, 0, 0)'}),
