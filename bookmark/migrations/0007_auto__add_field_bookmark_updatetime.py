...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bookmark.updatetime'
        db.add_column(u'bookmark_bookmark', 'updatetime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 7, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bookmark.updatetime'
        db.delete_column(u'bookmark_bookmark', 'updatetime')
    ...
    models = {
        ...
        u'ishuqian.user': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 27, 0, 0)'}),
