...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'ishuqian_follow', 'fans',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ishuqian.User']),
                      keep_default=False)
    ...
    models = {
        u'ishuqian.follow': {
            ...
            'fans': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'f+'", 'symmetrical': 'False', 'to': u"orm['ishuqian.User']"}),
            'hero': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'h+'", 'symmetrical': 'False', 'to': u"orm['ishuqian.User']"}),
